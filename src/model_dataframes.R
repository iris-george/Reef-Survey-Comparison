...
# re-order columns
full_dataframe <- full_dataframe[,c(2,1,22:24,3,4,8,10,13,14,21,25:33,9,12,5,11,
                                    34,15,16,6,17,35,18,19,7,20,36,37:39)]
...
SVCprey <- full_dataframe[,c(1:31,37)] 
...
SVCpred <- full_dataframe[,c(1:26,32:36,38)] 
