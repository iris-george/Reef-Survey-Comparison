...
# white grunt across sessions between SVC and prey surveys. 
...
# The following performs a Chi-Square test on presence/absence recordings of 
# bluestriped grunt across sessions between SVC and prey surveys. 
...
# The following performs a Chi-Square test on presence/absence recordings of 
# hogfish across sessions between SVC and prey surveys. 
...
# The following performs a Chi-Square test on presence/absence recordings of 
# mutton snapper across sessions between SVC and prey surveys. 
...
# The following performs a Chi-Square test on presence/absence recordings of 
# gray snapper across sessions between SVC and prey surveys. 
...
# The following performs a Chi-Square test on presence/absence recordings of 
# yellowtail snapper across sessions between SVC and prey surveys. 
...
# rename columns
yellowtail_snapper_SVC <- rename(yellowtail_snapper_SVC, presence = SVC_presence)
...
# The following performs a Chi-Square test on presence/absence recordings of 
# red grouper across sessions between SVC and prey surveys. 
...
# The following performs a Chi-Square test on presence/absence recordings of 
# black grouper across sessions between SVC and prey surveys. 
